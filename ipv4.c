...
void ipv4_got_tcp(intrace_t * intrace, ip4pkt_t * pkt, uint32_t pktlen, struct sockaddr_in *sa)
{
...
void ipv4_got_icmp(intrace_t * intrace, ip4pkt_t * pkt, uint32_t pktlen, struct sockaddr_in *sa)
{
	int id;
